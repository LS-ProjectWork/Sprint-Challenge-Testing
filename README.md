...
Describe breaks tests into components and it implements individual tests.

1. What is the point of `Test Driven Development`? What do you think about this approach?

The point of TDD is to make code that is functional and keeps the code succinct. I think it helps keep the code clean.

1. Mention three types of automated tests.

Regression, Unit and API
